...
##NOTE
If you're using Play with Angular2 _please_ consider voting on [this issue](https://github.com/angular/angular/issues/8571). It basically means that since RC0 Angular2 is no longer available through webjars. Which jeopardises the feasability of this kind of project.
